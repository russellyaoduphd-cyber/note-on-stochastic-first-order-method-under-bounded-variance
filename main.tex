...
\subsubsection{Verifying Constant Terms match in Proposition 8.6}
By using the closed form of $\tau$ and $\eta_k$, the desired result follows immediately.
\subsubsection{Verifying Function terms in Proposition 8.6}
