...
\begin{proof}[Proof of Lower Bound Half of Theorem~\ref{thm:main-rate}]
...
\subsection{Verification of Constant Terms in Proposition~\ref{prop:identity}}


\subsection{Verification of \dots Terms in Proposition~\ref{prop:identity}}
...
Our proof constructs explicit dual multipliers, given in closed form below, such that \begin{equation}\label{eq:certificate-identity}
\begin{aligned}
...
\begin{proposition}
The Gram multiplier $Z$ is positive semidefinite.
\end{proposition}
\begin{proof}
