...
\]
where Lemmas~\ref{lem:lambda-partial-sum} and~\ref{lem:lambda-outgoing-sum} are used, with the case $i=0$ following directly from $\lambda_{\star,0}=\alpha_0$. For $i=N$,
\[
