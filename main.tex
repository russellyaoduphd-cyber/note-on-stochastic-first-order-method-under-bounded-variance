...
Before we prove the coefficient match, we introduce some identities that will be used to reduce the proof complexity in the following section. Identities will be classified based on how to use them in the following section, which includes addressing the $\lambda$ coefficient, extracting coefficients from the $Z$ matrix, and completing the cancellation. 
